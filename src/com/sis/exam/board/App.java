...
public class App {
    ...
    private  void actionUserArticleDelete(Rq rq) {
        Map<String,String> params = rq.getParams();
    ...
    private void actionUserArticleModify(Rq rq) {
        Map<String,String> params = rq.getParams();
        if(params.containsKey("id")==false)
        {
            System.out.println("id를 입력해주세요.");
    ...
    private void actionUserArticleDetail(Rq rq) {
        Map<String,String> params = rq.getParams();
        if(params.containsKey("id")==false)
        {
            System.out.println("id를 입력해주세요.");
    ...
    private  void actionUserArticleWrite() {
    ...
    private  void actionUserArticleList(Rq rq) {
